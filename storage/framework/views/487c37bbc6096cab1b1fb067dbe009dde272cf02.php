        ...
        <div class="layout-wrapper landing">
                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center mt-lg-5 pt-5">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4">
                                    <a class="btn btn-primary" onclick="location.href='<?php echo e(route('landing.booknow')); ?>'">Book
            ...
            <section class="section bg-soft-primary" id="reviews">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="text-center mb-5">
                            <h3 class="mb-3 fw-semibold">Testimonia</h3>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applications\maheswari-app\resources\views/pages/landing/index.blade.php ENDPATH**/ ?>