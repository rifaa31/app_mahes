                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header border-0 align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1 text-center">Diagram Pemesanan Wedding Organizer</h4>
                                ...
                                <div class="row g-0 text-center">
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1"><span class="counter-value" data-target="758">0</span>
                                            </h5>
                                            <p class="text-muted mb-0">Jumlah Pemesanan</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="external-events">
                                ...
                                <div class="external-event fc-event bg-soft-success text-success"
                                    ...
                                    <i class="mdi mdi-checkbox-blank-circle font-size-11 me-2"></i>Wedding Organizer
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applications\maheswari-app\resources\views/index.blade.php ENDPATH**/ ?>