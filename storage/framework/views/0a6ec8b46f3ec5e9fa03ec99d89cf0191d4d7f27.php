            ...
            <form class="row g-3" method="POST" action="<?php echo e(route('booking.update_action')); ?>">
                ...
                <div class="col-md-4">
                    ...
                    <input name="customer" type="text" class="form-control" id="customer"
                        value="<?php echo e($data['customer']); ?>" placeholder="Nama Calon Pengantin">
                </div>
                <div class="col-md-4">
                    ...
                    <input name="number_phone" type="text" class="form-control" id="number_phone"
                        value="<?php echo e($data['number_phone']); ?>" placeholder="Nomor Handphone">
                </div>
                <div class="col-md-4">
                    ...
                    <input name="wedding_date" type="date" class="form-control" id="wedding_date"
                        value="<?php echo e($data['wedding_date']); ?>" placeholder="Tanggal Pernikahan">
                </div>
                <div class="col-md-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applications\maheswari-app\resources\views/pages/booking/update.blade.php ENDPATH**/ ?>