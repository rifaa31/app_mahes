                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user"
                                src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset('images/' . Auth::user()->avatar)); ?>

                                <?php else: ?><?php echo e(URL::asset('assets/images/users/user-dummy-img.jpg')); ?> <?php endif; ?>"
                                alt="Header Avatar">
...
<?php /**PATH E:\applications\maheswari-app\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>