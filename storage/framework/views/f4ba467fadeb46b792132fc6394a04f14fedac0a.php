                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img class="rounded" alt="200x200" width="200" src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>"
                                    data-holder-rendered="true">
                            </div><!-- end col -->
                            <div class="col-6">
                                <div class="mt-4 mt-md-0">
                                    <img class="rounded-circle avatar-xl" alt="200x200"
                                        src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" data-holder-rendered="true">
                                </div>
                            </div><!-- end col -->
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" class="figure-img img-fluid rounded"
                                        alt="...">
                            ...
                            <div class="col-sm-6">
                                <figure class="figure mb-0">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-5.jpg')); ?>" class="figure-img img-fluid rounded"
                                        alt="...">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applications\kp-maheswarienterprise\resources\views/ui-images.blade.php ENDPATH**/ ?>