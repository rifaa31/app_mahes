            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        case ('ru'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/russia.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('it'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/italy.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('sp'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/spain.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('ch'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/china.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('fr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/french.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php case ('gr'): ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/germany.svg')); ?>" class="me-2 rounded" alt="Header Language"
                                height="20">
                        <?php break; ?>
                        <?php default: ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/us.svg')); ?>" class="me-2 rounded" alt="Header Language" height="20">
                    <?php endswitch; ?>
                    </button>
...
<?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\minimal\Admin\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>