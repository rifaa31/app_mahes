...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 mb-2 ">
            ...
            <form method="POST" action="<?php echo e(route('user.update_action')); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\applications\maheswari-app\resources\views/pages/user/update.blade.php ENDPATH**/ ?>