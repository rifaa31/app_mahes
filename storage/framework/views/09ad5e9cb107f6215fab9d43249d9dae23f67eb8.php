                                ...
                                <div class="comment-widgets m-b-20">
                                    <div class="d-flex flex-row comment-row">
                                        <div class="p-2"><span class="round"><img
                                                    src="<?php echo e(URL::asset('assets/images/users/user-dummy-img.jpg')); ?>"
                                                    alt="Header Avatar" width="50"></span></div>
                                        
                                        <div class="comment-text w-100">
                                            <h5><?php echo e($item['customer_name']); ?></h5>
                                            <div class="comment-footer">
                                                <span class="date"><?php echo e($item['customer_date']); ?></span>
                                            </div>
                                            <p class="m-b-5 m-t-10"><?php echo e($item['massage']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
